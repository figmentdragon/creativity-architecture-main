...
function add_scripts() {
  ...
  wp_enqueue_style( 'child-style', get_stylesheet_directory_uri() . '/style.css', array( $style ), wp_get_theme()->get('Version') );
    ...
    wp_register_script( 'jquery.writer' , get_stylesheet_directory_uri() . '/assets/sripts/js/jQuery/jquery.writer.js', 'suggest' , '1.23', TRUE );
		wp_enqueue_script( 'jquery.writer' );
    wp_enqueue_script( 'fancybox', get_stylesheet_directory_uri() . '/assets/scripts/js/lib/lightbox/js/jquery.fancybox.pack.js', array( 'jquery' ), false, true );
    wp_enqueue_script( 'lightbox', get_stylesheet_directory_uri() . '/assets/scripts/js/lib/lightbox/js/lightbox.js', array( 'fancybox' ), '1.1', null , '1.0', TRUE );
    wp_enqueue_style( 'lightbox-style', get_stylesheet_directory_uri() . '/assets/scripts/css/lightbox/css/jquery.fancybox.css' );
  } elseif ( is_single() ) {
