...
if ( ! function_exists( 'creativityarchitect_get_setting' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_get_layout' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_get_footer_widgets' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_show_excerpt' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_show_title' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_padding_css' ) ) {
	/**
...
if ( ! function_exists( 'creativityarchitect_get_link_url' ) ) {
	/**
	 * Return the post URL.
	 *
...
if ( ! function_exists( 'creativityarchitect_get_navigation_location' ) ) {
	/**
