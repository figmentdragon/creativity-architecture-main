...
if ( ! function_exists( 'creativityarchitect_posted_on' ) ) :
	...
	function creativityarchitect_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( '%s', 'post date', 'creativityarchitect' ),
...
if ( ! function_exists( 'creativityarchitect_posted_by' ) ) :
	...
	function creativityarchitect_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( '%s', 'post author', 'creativityarchitect' ),
...
if (! function_exists('creativityarchitect_author_outside_loop')):
	function creativityarchitect_author_outside_loop(){
		global $post;
		$author_id=$post->post_author;
		esc_html_e('&nbsp; by &nbsp;', 'creativityarchitect'). the_author_meta( 'user_nicename', $author_id );
	}
endif;