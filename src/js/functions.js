 /* global creativityarchitectOptions */
 /*
 * Custom scripts
 * Description: Custom scripts for creativityarchitect Pro
 */

( function( $ ) {
	$( window ).on( 'load.creativityarchitect resize.creativityarchitect', function () {
		// Owl Carousel.
		if ( typeof $.fn.owlCarousel === "function" ) {
			// Featured Slider
			var sliderOptions = {
				rtl:creativityarchitectOptions.rtl ? true : false,
				autoHeight:true,
				margin: 0,
				items: 1,
				nav: true,
				...
				navText: [creativityarchitectOptions.iconNavPrev,creativityarchitectOptions.iconNavNext]
			};
			...
			var testimonialOptions = {
				...
				navText: [creativityarchitectOptions.iconTestimonialNavPrev,creativityarchitectOptions.iconTestimonialNavNext],
...
$( document ).ready( function() {
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
			.append( creativityarchitectOptions.dropdownIcon )
			.append( $( '<span />', { 'class': 'screen-reader-text', text: creativityarchitectOptions.screenReaderText.expand }) );

		container.find( '.menu-item-has-children > a, .page_item_has_children > a' ).after( dropdownToggle );
		container.find( '.menu-item-has-children > a, .page_item_has_children > a' ).append( creativityarchitectOptions.dropdownIcon );
		...
		container.find( '.dropdown-toggle' ).on( 'click', function( e ) {
			...
			// jscs:enable
			screenReaderSpan.text( screenReaderSpan.text() === creativityarchitectOptions.screenReaderText.expand ? creativityarchitectOptions.screenReaderText.collapse : creativityarchitectOptions.screenReaderText.expand );
		} );
	}
    ...
    jQuery( document ).ready( function() {
		...
		jQuery( window )
			.on( 'load.creativityarchitect resize.creativityarchitect', function() {
