	...
	register_taxonomy( 'custom_cat',
		...
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				...
				'item' => __( 'Parent Custom Category', 'TheCreativityArchitect' ), /* parent title for taxonomy */
				'item_colon' => __( 'Parent Custom Category:', 'TheCreativityArchitect' ), /* parent taxonomy title */
	...
	register_taxonomy( 'custom_tag',
		...
		array('hierarchical' => false,    /* if this is false, it acts like tags */
			'labels' => array(
				...
				'item' => __( 'Parent Custom Tag', 'TheCreativityArchitect' ), /* parent title for taxonomy */
				'item_colon' => __( 'Parent Custom Tag:', 'TheCreativityArchitect' ), /* parent taxonomy title */
