		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'TheCreativityArchitect' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'TheCreativityArchitect' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'TheCreativityArchitect' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'TheCreativityArchitect' ),
						'full'    => esc_html__( 'Full text', 'TheCreativityArchitect' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'TheCreativityArchitect' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
