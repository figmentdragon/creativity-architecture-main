...
function edd_sidebar() {
	...
	register_sidebar( array(
		'id'            => 'edd-sidebar',
		'name'          => __( 'Easy Digital Downloads Sidebar', 'TheCreativityArchitect' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle">',
		'after_title'   => '</h4>',
		'description'   => __( 'Widgets in this area will be shown on EDD archive pages.', 'TheCreativityArchitect' ),
	) );

	// Product page sidebar.
	register_sidebar( array(
		'id'            => 'edd-product-sidebar',
		'name'          => __( 'Easy Digital Downloads Product Page Sidebar', 'TheCreativityArchitect' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle">',
		'after_title'   => '</h4>',
		'description'   => __( 'Widgets in this area will be shown on EDD product pages.', 'TheCreativityArchitect' ),
	) );
...
function edd_menu_item( $markup = 'li' ) {
	...
	$title       = apply_filters( 'edd_menu_item_title', __( 'Shopping Cart', 'TheCreativityArchitect' ) );
	...
	if ( 'hide' !== get_theme_mod( 'edd_menu_item_count' ) ) {
		$menu_item .= '<span class="edd-menu-item-count">' . wp_kses_data( $cart_count ) . '<span class="screen-reader-text">' . __( 'Items in Cart', 'TheCreativityArchitect' ) . '</span></span>';
	}
