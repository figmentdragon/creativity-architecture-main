...
class Breadcrumbs {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label', 'TheCreativityArchitect' ),
			'home'                => esc_html__( 'Home', 'TheCreativityArchitect' ),
			'error_404'           => esc_html__( '404 Not Found', 'TheCreativityArchitect' ),
			'archives'            => esc_html__( 'Archives', 'TheCreativityArchitect' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Search results for: %s', 'TheCreativityArchitect' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Page %s', 'TheCreativityArchitect' ),
			// Translators: %s is the page number.
			'paged_comments'      => esc_html__( 'Comment Page %s', 'TheCreativityArchitect' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Minute %s', 'TheCreativityArchitect' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Week %s', 'TheCreativityArchitect' ),
