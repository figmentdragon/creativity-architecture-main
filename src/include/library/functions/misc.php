...
function main_menu_fallback() {
	...
	if ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) {
		...
		<ul class="menu">
			<li class="menu-item">
				<a href="javascript:void(0)" onclick="parent.wp.customize.panel( 'nav_menus' ).focus()"><?php _e( 'Add Menu', 'TheCreativityArchitect' ); ?></a>
			</li>
		</ul>
		...
		<ul class="menu">
			<li class="menu-item">
				<a href="<?php echo esc_url( admin_url( '/nav-menus.php' ) ); ?>"><?php _e( 'Add Menu', 'TheCreativityArchitect' ); ?></a>
			</li>
		</ul>
...
function menu_fallback() {
	...
	if ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) {
		...
		echo '<a href="' . esc_url( admin_url( '/nav-menus.php' ) ) . '">' . __( 'Add Menu', 'TheCreativityArchitect' ) . '</a>';
