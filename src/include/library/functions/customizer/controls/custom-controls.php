		...
		public function render_content() {
			...
			$important_links = array(
				'theme_instructions' => array(
					...
					'text'  => esc_html__( 'Theme Instructions', 'TheCreativityArchitect' ),
					),
				'support' => array(
					'link'  => esc_url( 'https://catchthemes.com/support/' ),
					'text'  => esc_html__( 'Support', 'TheCreativityArchitect' ),
					),
				'changelog' => array(
					'link'  => esc_url( 'https://catchthemes.com/changelogs/THEMENAME-theme/' ),
					'text'  => esc_html__( 'Changelog', 'TheCreativityArchitect' ),
					),
				'facebook' => array(
					'link'  => esc_url( 'https://www.facebook.com/catchthemes/' ),
					'text'  => esc_html__( 'Facebook', 'TheCreativityArchitect' ),
					),
				'twitter' => array(
					'link'  => esc_url( 'https://twitter.com/catchthemes/' ),
					'text'  => esc_html__( 'Twitter', 'TheCreativityArchitect' ),
					),
				'gplus' => array(
					'link'  => esc_url( 'https://plus.google.com/+Catchthemes/' ),
					'text'  => esc_html__( 'Google+', 'TheCreativityArchitect' ),
					),
				'pinterest' => array(
					'link'  => esc_url( 'http://www.pinterest.com/catchthemes/' ),
					'text'  => esc_html__( 'Pinterest', 'TheCreativityArchitect' ),
					),
			);
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'hide_if_empty'    => false,
					'show_option_all'  => esc_html__( 'All Categories', 'TheCreativityArchitect' ),
				)
			);
			...
			echo '<p class="description">' . esc_html__( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'TheCreativityArchitect' ) . '</p>';
		}
	}
	...
	class Multi_Cat_Project_Type extends WP_Customize_Control {
		...
		public function render_content() {
			...
			if ( ! taxonomy_exists( $taxonomy ) ) {
				echo '<p class="description">' . esc_html__( 'CPT Project Type does not exist. Make sure Essential Content Types plugin is activated with Portfolio CPT enabled.', 'TheCreativityArchitect' ) . '</p>';
			...
			<ul class="custom-sortable">
				...
				foreach ( $sortable_sections as $key => $value ) {
					...
					if ( isset( $value['section'] ) ) {
						echo '<a href="javascript:wp.customize.section( \'' . esc_attr( $value['section'] ) . '\' ).focus();">' . esc_html__( 'Edit', 'TheCreativityArchitect' ) . '</a>';
					}
					echo '</li>';
				}
			    ?>
