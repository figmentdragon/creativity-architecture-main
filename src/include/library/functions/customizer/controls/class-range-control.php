...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Range_Slider_Control' ) ) {
	...
	class Range_Slider_Control extends WP_Customize_Control {
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = __( 'Desktop','TheCreativityArchitect' );
			$this->json['tablet_label'] = __( 'Tablet','TheCreativityArchitect' );
			$this->json['mobile_label'] = __( 'Mobile','TheCreativityArchitect' );
			$this->json['reset_label'] = __( 'Reset','TheCreativityArchitect' );
