	...
	final class Customizer_Reset {
		...
		public function customize_controls_print_scripts() {
			...
			wp_localize_script( 'THEMENAME-customizer-reset', 'THEMENAMECustomizerReset', array(
				'reset'          => esc_html__( 'Reset', 'TheCreativityArchitect' ),
				'confirm'        => esc_html__( "Caution: Reset all settings to default. Process is irreversible.", 'TheCreativityArchitect' ),
				'nonce'          => array(
					'reset' => wp_create_nonce( 'THEMENAME-customizer-reset' ),
				),
				'resetSection'   => esc_html__( 'Reset section', 'TheCreativityArchitect' ),
				'confirmSection' => esc_html__( "Caution: Reset section settings to default. Process is irreversible.", 'TheCreativityArchitect' ),
			) );
		}
