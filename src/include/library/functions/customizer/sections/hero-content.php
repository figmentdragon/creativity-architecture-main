...
function hero_content_options( $wp_customize ) {
	$wp_customize->add_section( 'hero_content_options', array(
			'title' => esc_html__( 'Hero Content', 'TheCreativityArchitect' ),
			'panel' => 'theme_options',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Page', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'dropdown-pages',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Sub Headline', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'textarea',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Experience Title', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Date 1', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Experience 1', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Date 2', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Experience 2', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Date 3', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Experience 3', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Date 4', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
	...
	register_option( $wp_customize, array(
			...
			'sanitize_callback' => 'wp_kses_post',
			'active_callback'   => 'is_hero_content_active',
			'label'             => esc_html__( 'Experience 4', 'TheCreativityArchitect' ),
			'section'           => 'hero_content_options',
			'type'              => 'text',
		)
	);
