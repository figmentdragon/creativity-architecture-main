...
function testimonial_options( $wp_customize ) {
	...
	register_option( $wp_customize, array(
			...
			'label'             => sprintf( esc_html__( 'For Testimonial Options for Theme, go %1$shere%2$s', 'TheCreativityArchitect' ),
	...
	$wp_customize->add_section( 'testimonials', array(
			'panel'    => 'theme_options',
			'title'    => esc_html__( 'Testimonials', 'TheCreativityArchitect' ),
		)
	);
    ...
    register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Testimonial, install %1$sEssential Content Types%2$s Plugin with testimonial Type Enabled', 'TheCreativityArchitect' ),
	...
	register_option( $wp_customize, array(
			...
			'active_callback'   => 'is_testimonial_active',
			'label'             => esc_html__( 'Number of items', 'TheCreativityArchitect' ),
			'section'           => 'testimonials',
			'type'              => 'number',
			'input_attrs'       => array(
				'style'             => 'width: 100px;',
	...
	for ( $i = 1; $i <= $number ; $i++ ) {
		...
		register_option( $wp_customize, array(
				...
				'active_callback'   => 'is_testimonial_active',
				'label'             => esc_html__( 'Testimonial', 'TheCreativityArchitect' ) . ' ' . $i ,
				'section'           => 'testimonials',
				'type'              => 'select',
