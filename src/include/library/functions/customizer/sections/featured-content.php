...
function featured_content_options( $wp_customize ) {
    ...
    register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For all Featured Content Options for Theme, go %1$shere%2$s', 'TheCreativityArchitect' ),
    ...
    $wp_customize->add_section( 'featured_content', array(
			'title' => esc_html__( 'Featured Content', 'TheCreativityArchitect' ),
			'panel' => 'theme_options',
		)
	);
    ...
    register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Featured Content, install %1$sEssential Content Types%2$s Plugin with Featured Content Type Enabled', 'TheCreativityArchitect' ),
    ...
    register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For CPT heading and sub-heading, go %1$shere%2$s', 'TheCreativityArchitect' ),
	...
	register_option( $wp_customize, array(
			...
			'active_callback'   => 'is_featured_content_active',
			'description'       => esc_html__( 'Save and refresh the page if No. of Featured Content is changed (Max no of Featured Content is 20)', 'TheCreativityArchitect' ),
			'input_attrs'       => array(
				'style' => 'width: 100px;',
				'min'   => 0,
			),
			'label'             => esc_html__( 'No of Featured Content', 'TheCreativityArchitect' ),
			'section'           => 'featured_content',
			'type'              => 'number',
	...
	for ( $i = 1; $i <= $number ; $i++ ) {
		register_option( $wp_customize, array(
				...
				'active_callback'   => 'is_featured_content_active',
				'label'             => esc_html__( 'Featured Content', 'TheCreativityArchitect' ) . ' ' . $i ,
				'section'           => 'featured_content',
				'type'              => 'select',
