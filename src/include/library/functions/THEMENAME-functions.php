...
function comment( $comment, $args, $depth ) {
  ...
  <li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
    <div class="comment-body">
      <?php esc_html_e( 'Pingback:', 'TheCreativityArchitect' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( esc_html__( 'Edit', 'TheCreativityArchitect' ), '<span class="edit-link">', '</span>' ); ?>
    </div>
  <?php else : ?>
      ...
      <article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
        ...
        <div class="comment-container">
          <header class="comment-meta">
            <?php printf( __( '%s <span class="says screen-reader-text">says:</span>', 'TheCreativityArchitect' ), sprintf( '<cite class="fn author-name">%s</cite>', get_comment_author_link() ) ); ?>
            ...
            <a class="comment-permalink entry-meta" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
              ...
              <time datetime="<?php comment_time( 'c' ); ?>"><?php printf( esc_html__( '%s ago', 'TheCreativityArchitect' ), human_time_diff( get_comment_time( 'U' ), current_time( 'timestamp' ) ) ); ?></time></a>
              <?php edit_comment_link( esc_html__( 'Edit', 'TheCreativityArchitect' ), '<span class="edit-link">', '</span>' ); ?>
            </header><!-- .comment-meta -->
            <?php if ( '0' == $comment->comment_approved ) : ?>
              <p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'TheCreativityArchitect' ); ?></p>
            <?php endif; ?>
