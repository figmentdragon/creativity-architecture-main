...
/*************************************/
	...
	'name'          => __( 'Primary Sidebar', 'TheCreativityArchitect' ),
	'id'            => 'primary-sidebar',
	'description'   => __('Primary sidebar of the theme. Display on left or right side of the theme','TheCreativityArchitect'),
    'class'         => '',
...
/**********************************************************/
	...
	while ( $counter < $number_of_widgets ) : $counter++;
		...
		register_sidebar( array(
			'name'          => __( 'Footer ', 'TheCreativityArchitect' ) . $counter,
			'id'            => 'footer-' . $counter,
			'description'   => __( 'Footer bottom area vertical widgets.', 'TheCreativityArchitect' ),
