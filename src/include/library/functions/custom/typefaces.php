...
function fonts_url() {
	...
	*/
	...
	$raleway     = _x( 'on', 'Raleway font: on or off', 'TheCreativityArchitect' );
	$roboto      = _x( 'on', 'Roboto font: on or off', 'TheCreativityArchitect' );
	$open_sans   = _x( 'on', 'Open Sans font: on or off', 'TheCreativityArchitect' );
	$montserrat  = _x( 'on', 'Montserrat font: on or off', 'TheCreativityArchitect' );
	$droid_serif = _x( 'on', 'Droid Serif font: on or off', 'TheCreativityArchitect' );
	$cabin       = _x( 'on', 'Cabin font: on or off', 'TheCreativityArchitect' );
	$lato        = _x( 'on', 'Lato font: on or off', 'TheCreativityArchitect' );
