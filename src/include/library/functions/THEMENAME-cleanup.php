...
function theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', 'TheCreativityArchitect' ),   // main nav in header
			'footer-links' => __( 'Footer Links', 'TheCreativityArchitect' ) // secondary nav in footer
		)
	);
...
function related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'TheCreativityArchitect' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_postdata();
	echo '</ul>';
