...
class aboutme_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('about', /* Unique widget ID */
			esc_html__('THEMENAEs - About Me', 'TheCreativityArchitect'), /* Widget title display in widget area. */
			array( 'description' => esc_html__( 'About me widget content.', 'TheCreativityArchitect' ), ) /* Widget description */
		);
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'author_name' )); ?>"><?php esc_html_e( 'Author Name', 'TheCreativityArchitect' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'author_image' )); ?>"><?php esc_html_e( 'Upload Author Image', 'TheCreativityArchitect' ); ?></label>
		...
		<input type="button" value="<?php echo esc_attr(__('Select Image', 'TheCreativityArchitect')); ?>" name="<?php echo $this->get_field_name('author_image'); ?>" class="button button-primary media-upload" id="<?php echo $this->get_field_id('author_image'); ?>-button" />
		<br class="clear">
	</p>

	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'author_description')); ?>"><?php esc_html_e( 'Description', 'TheCreativityArchitect' ); ?></label>
