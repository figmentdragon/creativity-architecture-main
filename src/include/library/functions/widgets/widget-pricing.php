    ...
    public function __construct() {
        parent::__construct(
            'pricing', 'AP : Pricing Table', array(
                'description' => __('A widget that shows Pricing Table', 'TheCreativityArchitect')
            )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'pricing_plan' => array(
                ...
                'widgets_title' => __('Plan Name', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_plan_sub_text' => array(
                'widgets_name' => 'pricing_plan_sub_text',
                'widgets_title' => __('Sub Text', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_price_currency' => array(
                'widgets_name' => 'pricing_price_currency',
                'widgets_title' => __('Currency', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),

            'pricing_price' => array(
                'widgets_name' => 'pricing_price',
                'widgets_title' => __('Price', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_price_decimal' => array(
                'widgets_name' => 'pricing_price_decimal',
                'widgets_title' => __('Decimal Value', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_price_per' => array(
                'widgets_name' => 'pricing_price_per',
                'widgets_title' => __('Price Per', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature1' => array(
                'widgets_name' => 'pricing_feature1',
                'widgets_title' => __('Feature 1', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature1_font_a' => array(
                'widgets_name' => 'pricing_feature1_font_a',
                'widgets_title' => __('Feature 1 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature2' => array(
                'widgets_name' => 'pricing_feature2',
                'widgets_title' => __('Feature 2', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature2_font_a' => array(
                'widgets_name' => 'pricing_feature2_font_a',
                'widgets_title' => __('Feature 2 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature3' => array(
                'widgets_name' => 'pricing_feature3',
                'widgets_title' => __('Feature 3', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature3_font_a' => array(
                'widgets_name' => 'pricing_feature3_font_a',
                'widgets_title' => __('Feature 3 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature4' => array(
                'widgets_name' => 'pricing_feature4',
                'widgets_title' => __('Feature 4', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature4_font_a' => array(
                'widgets_name' => 'pricing_feature4_font_a',
                'widgets_title' => __('Feature 4 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature5' => array(
                'widgets_name' => 'pricing_feature5',
                'widgets_title' => __('Feature 5', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature5_font_a' => array(
                'widgets_name' => 'pricing_feature5_font_a',
                'widgets_title' => __('Feature 5 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature6' => array(
                'widgets_name' => 'pricing_feature6',
                'widgets_title' => __('Feature 6', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_feature6_font_a' => array(
                'widgets_name' => 'pricing_feature6_font_a',
                'widgets_title' => __('Feature 6 Font Awesome', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),

            'pricing_desc' => array(
                'widgets_name' => 'pricing_desc',
                'widgets_title' => __( 'Description', 'TheCreativityArchitect' ),
            ...
            'pricing_button_text' => array(
                ...
                'widgets_desc' => __('Leave Empty not to show', 'TheCreativityArchitect'),
                'widgets_field_type' => 'text',
            ),
            'pricing_button_link' => array(
                'widgets_name' => 'pricing_button_link',
                'widgets_title' => __('Button Link', 'TheCreativityArchitect'),
                'widgets_field_type' => 'url',
            ),
            'pricing_featured' => array(
                'widgets_name' => 'pricing_featured',
                'widgets_title' => __('Featured', 'TheCreativityArchitect'),
