...
function register_number_counter_widgets() {
    register_widget( 'WPTheCreativityArchitectNumber_Counter' );
}

class WPTheCreativityArchitectNumber_Counter extends WP_Widget {

    /* Register Widget with WordPress */
    function __construct() {
        parent::__construct(
            'number-counter',
            __( 'AP: Number Counter', 'TheCreativityArchitect' ),
            array( 'classname' => 'number-counter', 'description' => __( 'Number Animation Conter', 'TheCreativityArchitect' ) )
        );
    }
	 ...
	 private function widget_fields() {
		$fields = array(
            ...
            'counter' => array(
                ...
                'THEMENAMEc_widgets_title' => __('Counter','TheCreativityArchitect'),
    ...
    public function form( $instance ) {
        ...
        ?>
            ...
            <?php esc_html__('Counter Title', 'TheCreativityArchitect'); ?>
            </label>
            ...
            <?php esc_html__('Counter Number', 'TheCreativityArchitect'); ?>
            </label>
            ...
            <div class="startKnob" style="display: none;"><?php esc_html__( 'start', 'TheCreativityArchitect' ); ?></div>
