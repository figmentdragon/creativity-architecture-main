...
function widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($widgets_field_type) {
        ...
        case 'upload' :
            ...
            <label for="<?php echo esc_attr($instance->get_field_id($widgets_name)); ?>"><?php echo esc_html($widgets_title); ?></label><br/>
            <input id="<?php echo esc_attr($id); ?>" class="upload <?php echo esc_attr($class); ?>" type="text" name="<?php echo esc_attr($name); ?>" value="<?php echo esc_url($value); ?>" placeholder="<?php echo esc_attr_e('No file chosen', 'TheCreativityArchitect'); ?>" />
            <?php
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    ?>
                    <input id="upload-<?php echo esc_attr($id); ?>" class="upload-button button" type="button" value="<?php esc_attr_e('Upload', 'TheCreativityArchitect'); ?>" />
                    <?php
                } else {
                    ?>
                    <input id="remove-<?php echo esc_attr($id); ?>" class="remove-file button" type="button" value="<?php esc_attr_e('Remove', 'TheCreativityArchitect'); ?>" />
                    <?php
                }
            } else {
                ?>
                <p><i><?php esc_html_e('Upgrade your version of WordPress for full media support.', 'TheCreativityArchitect'); ?></i></p>
                <?php
            }
            ?>
            ...
            if ($value != '') {
                ...
                if ($image) {
                    ...
                    $title = esc_html__('View File', 'TheCreativityArchitect');
                    ?>
